...
export const resumeSchema = z.object({
  ...
  layout: z.object({
    ...
    sectionTitleFontSizes: z.object({
      profile: z.number().min(12).max(24).optional(),
      jobTarget: z.number().min(12).max(24).optional(),
      education: z.number().min(12).max(24).optional(),
